                            ...
                            <div class="p-2 w-1/2">
                                <div class="relative">
                                    ...
                                    <input type="email" id="email" name="email"
                                        ...
                                        class="w-full bg-white rounded border border-gray-300 focus:border-indigo-200 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                            </div>
                            ...
                            <div class="p-2 w-full">
                                <div class="relative">
                                    ...
                                    <textarea id="message" name="message"
                                        ...
                                        class="w-full bg-white rounded border border-gray-300 focus:border-indigo-200 focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                </div>
                            </div>
                            <div class="p-2 w-full">
